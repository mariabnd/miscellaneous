...
An overview of mailing lists or newsletters that are worth signing up for 

## Diseases
* [Coalition for Epidemic Preparedness Innovations (CEPI)](https://cepi.net/)
* [Global Research Collaboration for Infectious Disease Preparedness (GLOPID-R)](https://www.glopid-r.org/)
* [Institute for Health Metrics and Evaluation (IHME) newsletter](http://www.healthdata.org/)
* [Institute Pasteur newsletter](https://www.pasteur.fr/en)
* [Institute of Tropical Medicine (ITM) Antwerp newsletter](www.itg.be)
* [Models of Infectious Disease Agents (MIDAS) Center for Inference and Dynamics of Infectious Diseases (CIDID)](http://www.cidid.org/)
